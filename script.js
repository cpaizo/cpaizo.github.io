document.addEventListener('DOMContentLoaded', () => {
    ...
    const DEFAULT_LINKS = [
        ...
        { name: '202601 植髮紀錄系統', url: 'https://script.google.com/macros/s/AKfycbyyLvUR_XBMBRIkyLpUJW7VLwJqM2YCxHATgboyL1RpRstix8UeFuA4BmNLlhRcUw9t/exec' },
        { name: '202601 CPAIZO 閱讀分享平台', url: 'https://cpaizo-app.web.app/' },
